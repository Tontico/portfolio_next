        ...
        <>
            <form className=" relative h-5/6 w-1/2 phone:w-11/12 dark:bg-white bg-customDarkBg rounded-md mx-auto flex flex-col justify-center " onSubmit={handleSubmit}>
                 <div className=" w-11/12 h-full mx-auto p-5 mb-10 flex flex-col justify-center items-center ">
                    <h2 className="dark:text-black text-white text-center text-2xl mb-2 phone:m-0">Pour toutes demandes particulière !</h2>
                    ...
                    <span className="dark:text-black text-sm text-white">* Obligatoires</span>
                    ...
                    <button className="bg-customColor  rounded-full p-3 w-40  mx-auto text-white dark:text-customDarkBg absolute bottom-6 left-1/2 transform -translate-x-1/2">Soumettez</button>
                </div>
            </form>
