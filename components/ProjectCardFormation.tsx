                        ...
                        <div key={selectedProjectId} className="fixed top-2/4 left-2/4 transform -translate-x-1/2 -translate-y-1/2  rounded-md shadow-lg z-50  bg-gray-200 dark:bg-neutral-800 h-custom phone:h-5/6 media-modal phone:w-11/12 ">
                            ...
                            {!descriptionProject ? (
                                ...
                                <div className="w-full mx-auto mt-5">
                                    ...
                                    {selectedProject ? (
                                        <ul className={`w-11/12 mx-auto p-3  overflow-scroll scrollbar-thin border-2 rounded-md border-customColor border h-auto phone:h-${selectedProject.description.length < 6 ? '40' : '72'} text-sm mt-5 leading-relaxed phone:leading-snug tracking-wide phone:tracking-normal`}>
